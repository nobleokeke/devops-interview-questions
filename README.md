...
<details>
<summary> Given a string, extract everything until the first dot in the string. So given for example <code>mario.its.a.me</code> you'll get <code>mario</code></summary><br><b>

One possible way:

```
import re
until_dot_re = re.compile(r"^[^.]*")
re.search(until_dot_re, given_string).group(0)
```
</b></details>
